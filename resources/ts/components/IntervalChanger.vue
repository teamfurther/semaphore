<template>
    <div class="interval-changer">
        ...
        <div v-if="showIntervalChanger" class="bg-white shadow-md p-2 rounded absolute right-15 z-10">
            <div class="flex">
                <div class="w-64">
                    <div class="border-b-2 p-1 font-semibold mr-3">Absolute time ranges</div>
                    <div class="p-1 mt-3">Select date range</div>
                    <date-picker v-model="date" range v-bind:clearable="false"></date-picker>
                    <div class="p-1 mt-3">From</div>
                    <div class="flex">
                        <div class="date-holder">{{startDate}}</div>
                        <vue-timepicker v-model="startTime" auto-scroll class="time-holder" format="HH:mm" hide-clear-button></vue-timepicker>
                    </div>
                    ...
                    <button :disabled="disabled"
                            class="text-white font-bold py-1 px-2 rounded choose-btn"
...
export default class IntervalChanger extends Vue {
    private choosedDate = 'Last 30 minutes';
...
.mx-input:hover{
    border: 1px solid rgb(110, 203, 191);
}
...
.mx-calendar-content .cell.active {
    background-color: rgb(110, 203, 191);
}
...
.vue__time-picker-dropdown ul li:not([disabled]).active, .vue__time-picker-dropdown ul li:not([disabled]).active:focus, .vue__time-picker-dropdown ul li:not([disabled]).active:hover, .vue__time-picker .dropdown ul li:not([disabled]).active, .vue__time-picker .dropdown ul li:not([disabled]).active:focus, .vue__time-picker .dropdown ul li:not([disabled]).active:hover {
    background-color: rgb(110, 203, 191) !important;
}
