<template>
    <div class="view view--project">
        <div class="mb-8 flex">
          <div>
            <a href="/"><img class="pt-3 cursor-pointer" src="images/back-arrow.png" width="24"/></a>
          </div>
          <div class="ml-3">
          ...
          <div class="ml-auto">
            <interval-changer></interval-changer>
          </div>
        </div>
...
<script>
    ...
    export default {
        components: {
            Eol, Gauge, Trend, Uptime, Value, IntervalChanger
        }
    }
</script>
